...
v1.1 Release Documentation -- Readme.txt
...
Also thanks to:
---------------
Oddjob, Mr. Grim, and Dallas Frank of the A-Team; Mindvision for the great installer; MTG; A.J. McLean; 
Hyperboy; BetaMax @ GFN (Brent Bussey); Valve Software; Art Min; Erik Johnston; Stikky & Adrian @ Gameplay;
 Lestat, Anarchy, Matt; BizzyBlaster; D0gzilla; Chris Mair; Barking Dog Studios; Gamefan Network; 
Mutated Jellyfish; Gameplay.com; Darkman; TeamGT; Justin Bunnell, Hal; Erik Johnston @ Valve; Leon 
Hartwig; Arcticom's Fro; shirow @ mod central; Geronimo; Peter North; Eyeburn; all the server admins 
who have helped us test .dll's; RzE; MatteusX; John Jensen, Mr. Fraggle, all the CS mappers and 
texture artists; and the CS players. 
...
--readme.txt by cliffe : e-mail cliffe@counter-strike.net
